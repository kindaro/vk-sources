...
function createBox() {
ge('boxHolder').innerHTML = "<div id='boxFader' style='display: none'><div id='boxWrap'><div id='boxBody'><div id='nameLabel'><div id='boxTitle'></div></div><div id='boxMessage'></div><div class='buttons'><table align=right><tr><td><div id='button2Cont' class='button2' onMouseOver='b2_hover(this)' onMouseOut='b2(this)' onClick='return callBoxFunc(buttonFunc[1]);'><div class='button2Line'><div id='button2'>���</div></div></div></td></tr></table><table align=right><tr><td><div id='button1Cont' class='button1' onMouseOver='b1_hover(this)' onMouseOut='b1(this)' onClick='return callBoxFunc(buttonFunc[0]);'><div class='button1Line'><div id='button1'>��</div></div></div></td></tr></table></div></div></div><iframe id='boxGoodFrame' style='display: none;width:1000px; height: 1000px;'></iframe></div>";
}
