...
function goodGroupSuccess(ajaxObj,responseText) {
  ...
  ge('good'+ ajaxObj.gid).innerHTML = "<a href=\"javascript:badGroup(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">��� ��� �� ��������...</a>";
...
function goodAppSuccess(ajaxObj,responseText) {
  ...
  //ge('good'+ ajaxObj.aid).innerHTML = "<a href=\"javascript:badApp(" + ajaxObj.aid + ", '" + ajaxObj.hash + "')\">��� �� ����������...</a>";
}
...
function toDeleteSuccess(ajaxObj,responseText) {
  ge('inv'+ ajaxObj.gid).innerHTML = responseText;
  ge('todelete'+ ajaxObj.gid).innerHTML = "<a href=\"javascript:doNotDelete(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">��� �� �� ��������...</a>";
...
function doNotDeleteSuccess(ajaxObj,responseText) {
  ge('inv'+ ajaxObj.gid).innerHTML = responseText;
  ge('todelete'+ ajaxObj.gid).innerHTML = "<a href=\"javascript:toDelete(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">�� ��������</a>";
  ge('good'+ ajaxObj.gid).innerHTML = "<a href=\"javascript:goodGroup(" + ajaxObj.gid + ", '" + ajaxObj.hash + "')\">�� ��������</a>";
}
...
function banLinkSuccess(ajaxObj,responseText) {
  ge('linkact'+ ajaxObj.link_id).innerHTML = responseText;
  ge('blocked'+ ajaxObj.link_id).innerHTML = "<b>��</b>";
}
...
function viewSiteMessageSuccess(ajaxObj,responseText) {
  ...
  createBox();
  hide('button2Cont');
  ge('button1').innerHTML = "�������";
  ge("boxTitle").innerHTML = "����� ������� ��������� ��� " + json.url;
...
function viewVideoTextSuccess(ajaxObj,responseText) {
  ...
  hide('button2Cont');
  ge('button1').innerHTML = "�������";
  ge("boxTitle").innerHTML = "�������� � �������� ����� <a href='id" + ajax.mid + "'>id"+ ajax.mid + "</a>";
  ge("boxMessage").innerHTML = json.message;
  showBoxOld(function(){hideBox();});
  return false;
}
