...
function showRecentHistory(hash) {
  ...
  mb = new MessageBox({title: '������� ������������ ������', width: 600});
  mb.addButton( { label: '�������', onClick: function() { mb.hide(); }} );
...
function added(id, act, cb) {
  if (act == 'a_postpone') {
    searchSuccess({id: id}, "{html: '<div id=\"msg\" style=\"margin:10px 0px\">������ ��������.</div>'}");
...
function remove_informer_moder(id) {
  ...
  ajax.onDone = function(obj, text) {
    if (text.charAt(0) == 'e') {
      ...
      ge('moderator' + id + 'dellink').innerHTML = '<a href="#" onclick="return remove_informer_moder(' + id + ')">�������</a>';
    } else if (text.charAt(0) == 'g') {
      ...
      ge('moderator' + id + 'dellink').innerHTML = '<a href="#" onclick="return return_informer_moder(' + id + ')">������</a>';
    } else {
      ge('moderator' + id + 'dellink').innerHTML = '<a href="#" onclick="return remove_informer_moder(' + id + ')">�������</a>';
    }
  }
...
var Timepicker = function(el, options){
  ...
  var defaults = {
    ...
    h: 0,
    m: 0,
    format: '<div class="fl_l" style="padding:5px 3px 0 0;">� </div>{hour}<div class="fl_l" style="padding:5px 3px 0;"> : </div>{min}' //TEMP
  };
