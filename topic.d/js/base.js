...
function showText(obj, mess) {
 var imgPath;
 if (mess == 1) {ge(obj).innerHTML = "<h4>" + base_rotating + "<img src='http://vkontakte.ru/images/upload.gif'></h4>";}
 if (mess == 2) {ge(obj).innerHTML = "<div id='uploadingInner'><h4>" + base_uploading_photo + "<img src='http://vkontakte.ru/images/upload.gif'></h4><p style='margin-top:11px'>" + base_dont_close + "</p></div>";}
}