...
function submitItemForm(form) {
  // return if form is being submitt�d
  if (submitted) {
    return false;
  }
  submitted = true;
...
function showPhoto(url, photo_id) {
  ...
  if (!photoBox) {
    ...
    if (photosCount > 1) {
      photoBox.addButton({label: '�������', onClick: function() {
...
function user_moderation_status(id, status, sure) {
  ...
  if (status == -1 && !sure) {
    ...
    if (selected_items.length) {
      var confirm = new MessageBox({title: '��������������'});
      confirm.content('�� ������ ����� <b>������� ��� ������������</b> ���� ����������?');
      confirm.addButton({label: '���', onClick: function() { user_moderation_status(id, status, true); confirm.hide(); }});
      confirm.addButton({label: '��', onClick: function() { location.replace('/market.php?act=delete_warn&items=' + selected_items); }});
      confirm.show();
      return;
    }
  }
  ...
  ajax.onDone = function(obj, txt) {
    ...
    if (txt.substr(0, 1) != 'g') {
      ...
      if (status == 0) {
        ...
        ge('user_is_ok').innerHTML = "<a href='javascript: user_moderation_status(" + id + ", 1)'>�����������</a>";
        ge('user_attention').style.fontWeight = 'normal';
        ge('user_attention').innerHTML = "<a href='javascript: user_moderation_status(" + id + ", 2)'>��������������</a>";
        ...
        ge('user_warn').innerHTML = '������������';
        var btn = '<ul class="nNav" style="float: right"><li><b class="nc"><b class="nc1"></b><b class="nc2"></b></b><span class="ncc"><a href="javascript: user_moderation_status(' + id + ', -2)">������</a></span><b class="nc"><b class="nc2"></b><b class="nc1"></b></b></li></ul>';
        ge('itemsList').innerHTML = '<div id="user_warned_message" style="padding: 0px 10px 10px 10px"><div class="message">' + btn + '<div style="padding: 5px 0px">������������ ������������ � ��������� ������.</div></div></div>' + ge('itemsList').innerHTML;
      } else if (status == -2) {
        ...
        ge('user_warn').style.fontWeight = 'normal';
        ge('user_warn').innerHTML = "<a href='javascript: user_moderation_status(" + id + ", -1)'>������������</a>";
      } else if (status == -3) {
...
function unblacklist_user(user_id) {
  ...
  ajax.onDone = function(obj, text) {
    if (user_id) {
      ge('memberOptions_' + user_id).innerHTML = '<span style="font-weight: bold">������������ ������ �� ������� ������</span>';
...
function unspamlist_words(id) {
  ...
  ajax.onDone = function(obj, text) {
    if (id) {
      ge('memberOptions_' + id).innerHTML = '<span style="font-weight: bold">����� ������� �� ����-�������</span>';
