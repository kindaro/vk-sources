    ...
    onSuccess:function(obj,text) {
      ...
      if (res.postponed) {
        ...
        if (isFunction(onOK)) {
          ...
          var okMB = new AlertBox('������ ���������', res.html);
          okMB.show();
...
function showPostponedBox(hash) {
  if (!postponedMB) {
    postponedMB = new AlertBox('��������� �������', '', function(){return onSendPostponedCode(hash);}, {width:350, boxType:'CONFIRM', yes:getLang('captcha_send'), no:getLang('global_close')});
  }
